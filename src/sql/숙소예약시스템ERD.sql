...
CREATE TABLE "Coupon_Management" (
	"COUPON_MANAGEMENT_ID"	VARCHAR2		NOT NULL,
	"COUPON_ACTION"	VARCHAR2		NULL,
	"COUPON_MANAGEMENT_DATE"	DATE		NULL,
	"ADMIN_ID"	NOT NULL		NOT NULL,
	"COUPON_ID"	NOT NULL		NOT NULL
);
...
CREATE TABLE "Reservation" (
	...
	"RESERVATION_STATUS"	VARCHAR2		NULL
);
